...
const Header = () => {
  return (
      <header className="rounded-full py-2 px-8 flex justify-between items-center bg-F2F4F7 border-[1px] border-gray-200">
        ...
        <nav className="text-667085 font-semibold">
          <ul className="flex justify-around items-center gap-10">
            ...
            <li className="text-lg cursor-pointer">Pricing</li>
          </ul>
        </nav>
        <div className="flex gap-1">
          <button className="rounded-full px-4 py-3 text-base font-semibold text-gray-900 bg-white border-[1px] border-gray-400">
            Talk to sales
          </button>
